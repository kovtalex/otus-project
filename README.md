...
- Если сборка контейнеров и юнит тесты прошли успешно, то внесенные нами изменения выкатятся на **dev** окружение с тэгом хеша коммита.
...
URL_PROD | <http://url> окружения | К примеру внешний IP инстанса GCP.
